...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><h5>{{ __('employees_expense.Add New Expense') }}</h5></div>
                <div class="card-body">
					...
					{!! Form::open(array('route' =>'employees-expense-addstore','enctype'=>'multipart/form-data','method'=>'POST','files'=>'true')) !!}
						<div class="row">
							<div class="col-md-4">
        						<div class="form-group">
        							<label for="category_id" class=" col-form-label text-md-left">{{ __('employees_expense.Category') }}<em>*</em></label>
        							<div class="">
        					...
        					<div class="col-md-4">
        						<div class="form-group">
        							<label for="expense_date" class=" col-form-label text-md-left">{{ __('employees_expense.Expense Date') }}<em>*</em></label>
        				...
        				<div class="row">
        					<div class="col-md-4">
        						<div class="form-group">
        							<label for="pre_tax_amount" class=" col-form-label text-md-left">{{ __('employees_expense.Pre Tax Amount') }}<em>*</em></label>
        							<div class="">
        					...
        					<div class="col-md-4">
        						<div class="form-group">
        							<label for="tax_amount" class=" col-form-label text-md-left">{{ __('employees_expense.Tax Amount') }}<em>*</em></label>
        							<div class="">
    						...
    						<div class="col-md-12">
        						<div class="form-group">
        							<label for="expense_description" class=" col-form-label text-md-left">{{ __('employees_expense.Expense Description') }}<em>*</em></label>
        							<div class="">
